...
import {vendorSignUpApi} from "../../api/vendorApi/vendorAuth";
import VendorOtpComponent from "../../components/vendor/auth/VendorOtpComponent";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, {setErrors}) => {
      const modifiedValues = {
        ...
        GSTIN: values.GSTIN === "yes",
        ITR: values.ITR === "yes",
      };

      setIsLoading(true);
      try {
        const response = await vendorSignUpApi(modifiedValues);
